...
public:
  ...
  Mitarbeiter() { gehalt = 0.0; }

  Mitarbeiter(int palter, string pvorname, string pnachname, string padresse,
              double pgehalt)
      : Person(palter, pvorname, pnachname, padresse) {
    gehalt = pgehalt;
  }
...
int main() {
  Mitarbeiter m(35, "Sebastian", "Stabinger", "Thaur", 1000);
  m.print();
  m.geburtstag();
  m.print();
}
